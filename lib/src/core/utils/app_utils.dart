...
sealed class AppUtils {
  ...
  static const kPaddingLeft55Top5 = EdgeInsets.only(left: 55, top: 5);
  ...
  static const kPaddingT18 = EdgeInsets.only(top: 18,left: 16,right: 16);
  static const kPaddingT20 = EdgeInsets.only(top: 20);
  static const kPaddingT20B16 = EdgeInsets.only(top: 20,bottom: 16);
  static const kPaddingL16R16 = EdgeInsets.only(left: 16, right: 16);
  static const kPaddingR16 = EdgeInsets.only(right: 16);
  static const kPaddingT16L16 = EdgeInsets.only(left: 16, top: 16);
  static const kPaddingAll24 = EdgeInsets.all(24);
  static const kPaddingLeftAndTop12 = EdgeInsets.only(left: 12, top: 12);
  static const kPaddingLeftAndTop16 = EdgeInsets.only(left: 16, top: 16);
  ...
  static const kPaddingL16T8R16B2 = EdgeInsets.fromLTRB(16, 8, 16, 2);
  ...
  static const kPaddingL16R16Top10 = EdgeInsets.fromLTRB(16, 10, 16, 0);
  ...
  static const kBorderRadiusBottomL12R12 = BorderRadius.only(
